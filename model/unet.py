import paddle
from paddle.nn import Layer, LayerList, ReLU, BatchNorm2D, MaxPool2D, Conv2D, Conv2DTranspose, Upsample
...
class Encoder(Layer):
    def __init__(self, in_channels, out_channels):
        ...
        self.relus = LayerList(
            [ReLU() for i in range(2)])
        self.separable_conv_01 = SeparableConv2D(in_channels,
                                                 out_channels,
                                                 kernel_size=3,
                                                 padding='same')
        self.bns = LayerList(
            [BatchNorm2D(out_channels) for i in range(2)])
...
class SateNet(paddle.nn.Layer):
    def __init__(self, num_classes):
        super(SateNet, self).__init__()
